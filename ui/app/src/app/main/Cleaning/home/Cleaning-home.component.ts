...
@Component({
  selector: 'Cleaning-home',
  templateUrl: './Cleaning-home.component.html',
  styleUrls: ['./Cleaning-home.component.scss']
})
export class CleaningHomeComponent implements AfterViewInit {
