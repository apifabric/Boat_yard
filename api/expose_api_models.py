...
def expose_models(api, method_decorators = []): 
    ...
    api.expose_object(database.models.Boat, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.Cleaning, method_decorators= method_decorators)
    ...
    api.expose_object(database.models.Storage, method_decorators= method_decorators)
    return api
